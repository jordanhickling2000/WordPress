						...
						<div class="px-4 h-full">
							<div class="flex justify-end items-center h-full text-gray">
                                ...
                                */?>
								...
								<a class="ms-toolbar-button tipsy-tooltip-bottom-toolbar" title="<?php esc_attr_e('Add a new slideshow', 'ml-slider'); ?>" href="<?php echo wp_nonce_url(admin_url("admin-post.php?action=metaslider_create_slider"), "metaslider_create_slider"); ?>">
                                <svg class="w-6 p-0.5 text-gray-dark" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
